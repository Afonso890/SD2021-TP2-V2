...
public interface RestSpreadsheets {
	...
	/**
	 * Deletes the spreadsheets of the user userId when removing the user.  Only the owner can call this method.
	 * 
	 * @param sheetId - the sheet to be deleted.
	 * 
	 * @return 204 if the sheet was successful.
	...
	@Produces(MediaType.APPLICATION_JSON)
	String[][] importRange(@PathParam("sheetId") String sheetId, @PathParam("range") String range,@PathParam("email") String email);
